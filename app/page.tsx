...
const regions = [
  ...
  { id: 'TOAMASINA', name: 'Toamasina', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSe5vZnps3IXnLA6o7tgmAJ31aioZxkZPMkow&s', description: 'Port de l\'est' },
  { id: 'MAHAJANGA', name: 'Mahajanga', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS9pP2kprGD2btJ-tHkrqQA267LGLsxALQeiw&s', description: 'Ville des baobabs' },
  { id: 'FIANARANTSOA', name: 'Fianarantsoa', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQf0vlw_U9W5TVVawiImExq0BlfWfEQ-IvNlA&s', description: 'Route du vin' },
  { id: 'ANTSIRANANA', name: 'Antsiranana', image: 'https://www.booking-hotel-madagascar.com/wp-content/uploads/2017/04/antsiranana.jpg', description: 'Baie des Français' },
  { id: 'TOLIARA', name: 'Toliara', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMLcbNEytcdOmPYiBdfOjE47eMpGIwc9aqUQ&s', description: 'Porte du sud' },
]
